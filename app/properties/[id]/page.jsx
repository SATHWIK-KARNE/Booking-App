            ...
            <div className="container m-auto py-10 px-6">
              <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
                ...
                <aside className="space-y-4 mt-4">
                  <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold w-full py-4 px-4 rounded-full flex items-center justify-center">
                    <i className="fas fa-bookmark mr-2"></i> Bookmark Property
                  </button>
                  <button className="bg-orange-500 hover:bg-orange-600 text-white font-bold w-full py-4 px-4 rounded-full flex items-center justify-center">
